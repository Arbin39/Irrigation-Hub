    ...
    <div class="images">
        <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #178B23;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <div class="d-flex justify-content-center align-items-center" style="width: 70vw;">
                        ...
                        <div class="form-inline login-btn">
                            ...
                            if (isset($_SESSION['status']) && $_SESSION['status'] === 'logedin') {
                                echo '<a class="nav-item text-center" href="?logout" style="color: #FFFFFF;">Logout</a>';
                            } else {
                                echo '<a class="nav-item text-center" href="login.php#contact" style="color: #FFFFFF;">Login</a>';
                            }
                            ?>
                        </div>
                        <div>
                ...
                <div class="form-inline login-btn " >
                    <a class="nav-item  text-center " href="login.php" style="color: #FFFFFF;">log In</a>
                </div>
            </div>
        </nav>
